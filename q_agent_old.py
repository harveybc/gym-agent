# agent_DQN:  implements deep q learning agent that uses the gym-forex environment,
# the evaluate() method uses a pretrained network or a dummy starting network to start the evaluation.
